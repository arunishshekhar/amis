...
Devvit.addSettings([
  ...
  {
    name: 'AI_API_KEY',
    label: 'AI Provider API Key — OpenAI / Gemini / Claude key (required for all except Custom)',
    type: 'string',
    isSecret: true,
    scope: 'app',
  },
  {
    ...
    label: 'Custom Base URL — only for Custom provider (e.g. http://localhost:11434/v1)',
    type: 'string',
    isSecret: false,
    scope: 'app',
  },
  {
    name: 'CUSTOM_MODEL',
    label: 'Custom Model Name — only for Custom provider (e.g. llama3)',
    type: 'string',
    isSecret: false,
    scope: 'app',
  },
